...
class ActivityConverter {
    ...
    fun activityToDatabase(activity: ActivitiesDatabaseType): HashMap<String, Any> {
        return when (activity.sport) {
            ActivitiesDatabaseType.Sports.HIKING -> trailToDatabase(activity as ActivitiesDatabaseType.Trail)
            ActivitiesDatabaseType.Sports.CLIMBING -> climbToDatabase(activity as ActivitiesDatabaseType.Climb)
        }
    }

    fun databaseToActivity(data: HashMap<String, Any>, activityType: ActivitiesDatabaseType.Sports): ActivitiesDatabaseType {
