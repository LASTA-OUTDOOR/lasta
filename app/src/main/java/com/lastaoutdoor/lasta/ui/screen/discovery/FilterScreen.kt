...
fun FilterScreen(navController: NavController) {
    ...
    Column(modifier = Modifier
        ...
        Text(text = stringResource(id = R.string.filter_activity_type), style =
        TextStyle(
            fontSize = 20.sp, lineHeight = 24.sp, fontWeight = FontWeight(500)))
        ...
        Text(text = stringResource(id = R.string.filter_difficulty_level), style =
        TextStyle(
            fontSize = 20.sp, lineHeight = 24.sp, fontWeight = FontWeight(500)))
        ...
        Row(verticalAlignment = Alignment.CenterVertically) {
            ...
            Text(text = stringResource(id = R.string.show_completed_activities), style =
            TextStyle(
                fontSize = 20.sp, lineHeight = 24.sp, fontWeight = FontWeight(500), color = AccentGreen))
        }
        ...
        Text(text = stringResource(id = R.string.filter_distance_range), style =
        TextStyle(
            fontSize = 20.sp, lineHeight = 24.sp, fontWeight = FontWeight(500)))
        Spacer(modifier = Modifier.height(12.dp))
        Row (verticalAlignment = Alignment.CenterVertically) {
